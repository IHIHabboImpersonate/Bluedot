...
namespace Bluedot.HabboServer.Useful.Collections
{
    public class NestedSetList<T> : ICollection<T>
    {
        ...
        /// </summary>
        private readonly Dictionary<T, NestedSetData> _values;
        ...
        public NestedSetList(T root)
        {
            _values = new Dictionary<T, NestedSetData>
                        {
                            {
                            root, new NestedSetData
                                {
                                    Left = 0,
                                    Right = 1
                                }
