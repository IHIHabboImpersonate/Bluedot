...
{
    internal class HabboDistributor
    {
        #region Fields
        ...
        internal Habbo GetHabbo(string username)
        {
            lock (this)
            {
        ...
        internal Habbo GetHabbo(int id)
        {
            lock (this)
            {
        ...
        internal Habbo GetHabbo(string ssoTicket, IPAddress origin)
        {
        ...
        public Habbo GetPreLoginHabbo(GameSocket socket)
        {
        ...
        private void CacheHabbo(Habbo theHabbo)
        {
            ...
            {
                // Cache the Habbo.
                _habboCache.Add(theHabbo.Id, new WeakReference(theHabbo));
                // Cache the Username-ID.
                _usernameIDCache.Add(theHabbo.Username, theHabbo.Id);
            }
        }
