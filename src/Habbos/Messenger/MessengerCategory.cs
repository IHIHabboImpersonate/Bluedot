...
namespace Bluedot.HabboServer.Habbos.Messenger
{
    ...
    public class MessengerCategory
    {
        ...
        private static readonly BluedotDictionary<int, Habbo>.WeakReferenceBehaviour _habboWeakReferenceBehaviour = new BluedotDictionary<int, Habbo>.WeakReferenceBehaviour(true, id => CoreManager.ServerCore.HabboDistributor[id]);
